...
<html>
	...
	<body>
		<p>
			<?php
				echo "<br>";
				echo "<h1>".$user_data['user_name']." Profile";
				if ($user_data['user_id'] != $_SESSION['user_id']){
				echo "<h3><a class='request' href='report.php?user_id=".$user_data["user_id"]."'> Report this User </a></h3> ";	
				}
				echo "</h1>";
				echo "<a class='home' href='index.php'>Home</a> <br>";
				echo "<br>";
		...
		<?php 
			...
			if ($user_data['user_id'] != $_SESSION['user_id']){
				echo "<h3><a class='request' href='transactions.php?user_name=".$user_data["user_name"]."'> Make a Request</a></h3> ";	
			}
